...
export default function Topservice() {
  return (
    <div className='services bg-[] w-[100vw] '>
    <div >

<div className='w-[90vw] m-[auto] p-[25px] flex items-center justify-center flex-col ' >

  <h1 className = 'text-[40px] font-[600] mb-[50px] xs:text-[38px]'    >Our Services</h1>
  ...
  <div className='w-[300px] h-[250px] bg-[#DBE7C9] rounded-[20px] flex flex-col items-center justify-center p-[10px] pt-[20px] gap-[20px] service-col'   >
    <p className = 'font-[700] text-[25px] text-center'>Software requirements management  </p>
     <img src='images/software.png' alt='software' className= 'w-[65px] h-[65px]'/> 
    <p className='text-[12px] font-[600] text-center'>
  ...
  <div className='w-[300px] h-[250px] bg-[#DBE7C9] rounded-[20px] flex flex-col items-center justify-center pt-[20px]  p-[10px] gap-[20px] service-col'   >
    <p className = 'font-[700] text-[25px] text-center'>Application software development service</p>
     <img src='images/application.png' alt='applicatio' className= 'w-[65px] h-[65px]'/> 
    <p className='text-[12px] font-[600] text-center'>
